...
ENET_API ENetHost * enet_host_createByFd (const ENetAddress *, size_t, size_t, enet_uint32, enet_uint32, enet_uint32);
ENET_API void       enet_host_destroy (ENetHost *);
ENET_API void       enet_host_destroyByFd (ENetHost *);
